...
VAL_IMGS = Path(__file__).parent.parent / "data-creation" / "data" / "clean_split" / "val" / "images"
VAL_LABS = Path(__file__).parent.parent / "data-creation" / "data" / "clean_split" / "val" / "labels"

...
Analyzed `316` runs from `/tmp/accounting-logs`.
...
- annual_close clean rate is 57.1%; blockers: none; likely missing fields: none
- cost_analysis clean rate is 16.7%; blockers: activity_type_required; likely missing fields: activity, employee, project
- department clean rate is 60.0%; blockers: duplicate_identifier, module_permission_blocked; likely missing fields: department
- employee clean rate is 53.1%; blockers: email_validation; likely missing fields: employee, department
- product clean rate is 40.7%; blockers: sandbox_valid_vat_type; likely missing fields: none
...
- travel_expense clean rate is 44.4%; blockers: employee_time_access, rate_category_date_mismatch, travel_expense_kind, travel_expense_contents_required; likely missing fields: delivered_state, employee, rate_type, per_diem_completion
...
- Likely full runs: 0
- Likely partial runs: 6
- Mean API errors: 6.00
- Prompt-required fields: none
- Likely blockers: activity_type_required
- Missing-field hypotheses: activity, employee, project
- Top error: /activity: HTTP 422 with no captured body

### customer

- Runs: 35
- Proxy clean rate: 91.4%
- Likely full runs: 30
...
- Runs: 25
- Proxy clean rate: 60.0%
- Likely full runs: 13
- Likely partial runs: 3
- Mean API errors: 0.68
- Prompt-required fields: none
- Likely blockers: duplicate_identifier, module_permission_blocked
...
- Runs: 32
- Proxy clean rate: 53.1%
- Likely full runs: 15
- Likely partial runs: 2
- Mean API errors: 0.56
- Prompt-required fields: none
...
- Runs: 40
- Proxy clean rate: 77.5%
- Likely full runs: 30
- Likely partial runs: 3
- Mean API errors: 1.10
- Prompt-required fields: none
...
- Runs: 27
- Proxy clean rate: 40.7%
- Likely full runs: 11
- Likely partial runs: 2
- Mean API errors: 13.04
- Prompt-required fields: none
...
- Runs: 17
- Proxy clean rate: 70.6%
- Likely full runs: 5
- Likely partial runs: 10
- Mean API errors: 3.47
- Prompt-required fields: none
- Likely blockers: project_hourly_rates_endpoint, module_permission_blocked, duplicate_identifier
...
- Runs: 21
- Proxy clean rate: 90.5%
- Likely full runs: 17
- Likely partial runs: 2
- Mean API errors: 0.19
- Prompt-required fields: none
- Likely blockers: none
...
- Runs: 29
- Proxy clean rate: 86.2%
- Likely full runs: 24
- Likely partial runs: 4
- Mean API errors: 0.90
- Prompt-required fields: none
- Likely blockers: module_permission_blocked
- Missing-field hypotheses: project, activity, vat_type
...
- Missing-field hypotheses: delivered_state, employee, rate_type, per_diem_completion, project, travel_expense_type_or_travel_details
